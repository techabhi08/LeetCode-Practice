...
<pre style="position: relative;"><strong>Input:</strong> arr = [0,10,20,30], fn = function greaterThan10(n) { return n &gt; 10; }
...
<pre style="position: relative;"><strong>Input:</strong> arr = [1,2,3], fn = function firstIndex(n, i) { return i === 0; }
...
<pre style="position: relative;"><strong>Input:</strong> arr = [-2,-1,0,1,2], fn = function plusOne(n) { return n + 1 }
