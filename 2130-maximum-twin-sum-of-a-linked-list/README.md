...
<pre style="position: relative;"><strong>Input:</strong> head = [5,4,2,1]
...
<pre style="position: relative;"><strong>Input:</strong> head = [4,2,2,3]
...
<pre style="position: relative;"><strong>Input:</strong> head = [1,100000]
